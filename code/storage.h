	...
	#define EAD_INPUT_END	(EAD_INPUT_BASE+(EAD_INPUT_SIZE*HW_INPUTS))
	...
	#define EAD_MODEL_SLOT_SIZE		((EAD_MODEL_OUTPUT_SIZE*PPM_OUTPUT_COUNT) + EAD_MODEL_FLAG_SIZE + EAD_MODEL_NAME_SIZE + (EAD_MODEL_INPUT_SIZE*HW_INPUTS) + EAD_MODEL_INPUT_TOGGLING_BOUNDS_SIZE + EAD_MODEL_INPUT_LEVELING_TABLE_SIZE + EAD_MODEL_ALIGNMENT)
